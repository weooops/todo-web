...
const dict = {
  ...
  ko: {
    ...
    'Sign in to your account': '로그인 하세요',
    Username: '사용자 이름',
    Password: '비밀번호',
    'Enter your username': '사용자 이름을 입력하세요',
    'Enter your password': '사용자 비밀번호를 입력하세요',
    'Forget your password? ': '비밀번호를 잊어 버렸어요? ',
    'Reset password': '암호 재설정',
    'No account? ': '계정이 없어요? ',
    'Create account': '계정 만들기',
    'Sign In': '로그인',
    'Create a new account': '새로운 계정을 생성하세요',
    'Create a username': '사용자 이름을 만드세요',
    'Create a password': '사용자 비밀번호를 만드세요',
    'Email Address': '이메일 주소',
    'Phone Number': '핸드폰 번호',
    'Have an account? ': '계정이 있나요? ',
    'Sign in': '로그인',
    'Create Account': '회원가입',
    'Reset your password': '비밀번호를 재설정 하세요',
